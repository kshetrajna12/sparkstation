...
docker pull --platform "$PLATFORM" nvcr.io/nvidia/vllm:25.11-py3
...
CUDA_TEST=$(docker run --platform "$PLATFORM" --gpus all --rm nvcr.io/nvidia/vllm:25.11-py3 \
...
update_env_var "VLLM_DOCKER_IMAGE" "nvcr.io/nvidia/vllm:25.11-py3" "$ENV_FILE"
...
echo "  - vLLM: nvcr.io/nvidia/vllm:25.11-py3 ($PLATFORM)"
echo ""
